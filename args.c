...
const char *gengetopt_args_info_usage = "Usage: nanoShell [OPTIONS]...";
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->mode_1_mode_counter = 0 ;
  args_info->mode_2_mode_counter = 0 ;
  args_info->mode_3_mode_counter = 0 ;
}
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_help = gengetopt_args_info_help[5] ;
  args_info->signalfile_help = gengetopt_args_info_help[7] ;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* file.  */
          args_info->mode_1_mode_counter += 1;
        ...
        case 'm':	/* max.  */
          ...
          break;
        case 's':	/* signalfile.  */
          args_info->mode_3_mode_counter += 1;
  ...
  if (args_info->mode_1_mode_counter && args_info->mode_2_mode_counter) {
    int mode_1_given[] = {args_info->file_given,  -1};
    const char *mode_1_desc[] = {"--file",  0};
    int mode_2_given[] = {args_info->max_given,  -1};
    const char *mode_2_desc[] = {"--max",  0};
    error_occurred += check_modes(mode_1_given, mode_1_desc, mode_2_given, mode_2_desc);
  }
  if (args_info->mode_1_mode_counter && args_info->mode_3_mode_counter) {
    int mode_1_given[] = {args_info->file_given,  -1};
    const char *mode_1_desc[] = {"--file",  0};
    int mode_3_given[] = {args_info->signalfile_given,  -1};
    const char *mode_3_desc[] = {"--signalfile",  0};
    error_occurred += check_modes(mode_1_given, mode_1_desc, mode_3_given, mode_3_desc);
  }
  if (args_info->mode_2_mode_counter && args_info->mode_3_mode_counter) {
    int mode_2_given[] = {args_info->max_given,  -1};
    const char *mode_2_desc[] = {"--max",  0};
    int mode_3_given[] = {args_info->signalfile_given,  -1};
    const char *mode_3_desc[] = {"--signalfile",  0};
    error_occurred += check_modes(mode_2_given, mode_2_desc, mode_3_given, mode_3_desc);
  }
